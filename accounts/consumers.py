...
class RoomConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        ...
        # Observer Pattern: Joining a group to receive updates (subject is channel_layer, observers are WebSocket clients)
    ...
    async def disconnect(self, close_code):
        # Observer Pattern: Leaving the group stops receiving updates
    ...
    async def receive(self, text_data):
        try:
            ...
            if message_type == 'chat_message':
                ...
                # Observer Pattern: Broadcasting message to all group members (observers)
    ...
    # Proxy Pattern: database_sync_to_async acts as a proxy to mediate synchronous DB access in an async context
    ...
    # Proxy Pattern: Proxying DB access for retrieving room object
    @database_sync_to_async
